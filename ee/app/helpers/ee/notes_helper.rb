...
module EE
  module NotesHelper
    ...
    def notes_url(params = {})
      ...
      return namespace_project_security_vulnerability_notes_path(@vulnerability.project, @vulnerability) if @vulnerability.is_a?(Vulnerability)
    ...
    def discussions_path(issuable)
      ...
      return discussions_project_vulnerability_path(issuable.project, issuable, format: :json) if issuable.is_a?(Vulnerability)
