...
import { readableTimeFormat, secondsToMilliseconds } from '~/lib/utils/datetime_utility';
...
export const formattedTime = timeInSeconds => readableTimeFormat(secondsToMilliseconds(timeInSeconds));
