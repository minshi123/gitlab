  ...
  class Branches < Grape::API::Instance
    ...
    resource :projects, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      get ':id/repository/branches' do
        ...
        if Feature.enabled?(:gitaly_branch_pagination, user_project)
          branches = BranchesFinder.new(repository, declared_params(include_missing: false)).with_gitaly_pagination
        else
