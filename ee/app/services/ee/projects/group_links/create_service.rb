    ...
    module GroupLinks
      module CreateService
        ...
        def allowed_to_be_shared_with?(group)
          project_can_be_shared_with_group = check_if_project_can_be_shared_with_group(group, project)
          source_project_can_be_shared_with_group = project.forked? ? check_if_project_can_be_shared_with_group(group, project.forked_from_project) : true

          project_can_be_shared_with_group && source_project_can_be_shared_with_group
        end

        def check_if_project_can_be_shared_with_group(group, given_project)
