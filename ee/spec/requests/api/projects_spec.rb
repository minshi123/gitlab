      ...
      context 'when compliance_framework feature is available' do
        ...
        context 'when project has a compliance framework' do
          ...
          it 'exposes framework names as array of strings' do
            expect(json_response).to have_key 'compliance_frameworks'
        ...
        context 'when project has no compliance framework' do
          ...
          it 'returns an empty array' do
            expect(json_response).to have_key 'compliance_frameworks'
            expect(json_response['compliance_frameworks']).to match_array([])
          end
        end
      end

      context 'when compliance_framework feature is unavailable' do
        before do
        ...
        it 'is not exposed' do
          ...
          expect(json_response).not_to have_key 'compliance_frameworks'
        end
      end
    end
