...
| Python     | [pip](https://pip.pypa.io/en/stable/) (Python is supported via `requirements.txt` and `Pipfile.lock`) |[License Finder](https://github.com/pivotal/LicenseFinder)|
