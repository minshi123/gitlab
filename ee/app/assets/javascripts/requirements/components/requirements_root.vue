...
import RequirementTabs from './requirements_tabs.vue';
  ...
  computed: {
    ...
    totalRequirementsForCurrentTab() {
      if (this.filterBy === FilterState.opened) {
        return this.openedCount === 0 ? 0 : this.requirementsCount.OPENED;
      } else if (this.filterBy === FilterState.archived) {
        return this.archivedCount === 0 ? 0 : this.requirementsCount.ARCHIVED;
      }
