...
CREATE INDEX index_metrics_dashboard_annotations_on_cluster_id_and_4_columns ON public.metrics_dashboard_annotations USING btree (cluster_id, dashboard_path, starting_at, ending_at, panel_xid) WHERE (cluster_id IS NOT NULL);

CREATE INDEX index_metrics_dashboard_annotations_on_environment_id_and_4_col ON public.metrics_dashboard_annotations USING btree (environment_id, dashboard_path, starting_at, ending_at, panel_xid) WHERE (environment_id IS NOT NULL);
