        ...
        def usage_activity_by_stage_configure(time_period)
          {
            ...
            clusters_management_project: distinct_count(::Clusters::Cluster.with_management_project.where(time_period), :user_id),
            ...
            instance_clusters_disabled: distinct_count(::Clusters::Cluster.disabled.instance_type.where(time_period), :user_id),
            instance_clusters_enabled: distinct_count(::Clusters::Cluster.enabled.instance_type.where(time_period), :user_id),
