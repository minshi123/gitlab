...
module Types
  class EpicType < BaseObject
    ...
    field :descendant_counts, Types::EpicDescendantCountType, null: true, complexity: 2,
    ...
    field :descendant_weight_sum, Types::EpicDescendantWeightSumType, null: true, complexity: 2,
