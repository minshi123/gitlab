...
export const receiveMetricsDashboardSuccess = ({ commit, dispatch }, { response, params }) => {
  ...
  commit(
    ...
    convertObjectPropsToCamelCase(dashboard, {
      deep: true,
      // Keys should be removed from the list below
      // as they get switched to camel case in other charts and components
      // https://gitlab.com/gitlab-org/gitlab/issues/207198
      ignoreKeyNames: ['x_label', 'y_label', 'x_type', 'max_value'],
    }),
  );
  commit(types.SET_ENDPOINTS, convertObjectPropsToCamelCase(response.metrics_data, { deep: true }));
