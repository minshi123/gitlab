    ...
    context 'if the CI report contains some entries' do
      context 'and the entries are valid' do
        ...
        it 'creates test report with expected status for each open requirement' do
          # also ignores requirement IIDs that appear in the test but are missing or archived
      ...
      context 'and the entries are not valid' do
        ...
        it 'creates test report with expected status for each open requirement' do
          # requirement IIDs that appear in the test but are missing or archived
          requirement1 = create(:requirement, state: :opened, project: project, iid: 1)
          requirement2 = create(:requirement, state: :opened, project: project, iid: 2)
