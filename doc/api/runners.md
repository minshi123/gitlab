...
CAUTION: **Deprecation**
> The `token` attribute in the response is deprecated.
> Introduced [GitLab 12.10](https://gitlab.com/gitlab-org/gitlab/-/issues/214320).
> Will be removed in [GitLab 13.0](https://gitlab.com/gitlab-org/gitlab/-/issues/214322).
