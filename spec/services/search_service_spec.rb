  ...
  describe '#search_objects' do
    ...
    context 'redacting search results' do
      ...
      context 'issues' do
        ...
        let(:unredacted_results) { Issue.id_in([readable.id, unreadable.id]) }
        let(:scope) { 'issues' }
      ...
      context 'notes' do
        ...
        let(:unredacted_results) { Note.id_in([readable.id, unreadable.id]) }
        let(:scope) { 'notes' }
      ...
      context 'merge_requests' do
        ...
        let(:unredacted_results) { MergeRequest.id_in([readable.id, unreadable.id]) }
      ...
      context 'project repository blobs' do
        ...
        let(:unredacted_results) { [readable, unreadable] }
        let(:scope) { 'blobs' }
      ...
      context 'users' do
        ...
        let(:unredacted_results) { User.id_in([user.id, other_user.id]) }
        let(:scope) { 'users' }
