...
| [SPDX license list import](spdx.md) **(PREMIUM ONLY)**                                              | Import a local copy of the [SPDX license list](https://spdx.org/licenses/) for [License Compliance policies](../user/compliance/license_compliance/index.md) matching.|                                                     |
