  ...
  computed: {
    ...
    importWarningMessage() {
      return this.numberOfPreviousImportsForProject > 0
        ? __(
            `You have imported from this project ${this.numberOfPreviousImportsForProject} times before. Each new import will create duplicate issues.`,
          )
        : undefined;
    },
  },
...
<template>
  <div>
    ...
    <gl-alert v-if="importWarningMessage" variant="warning" :dismissible="false">
      {{ importWarningMessage }}
    </gl-alert>
