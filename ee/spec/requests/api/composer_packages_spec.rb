  ...
  describe 'GET /api/v4/group/:id/-/packages/composer/packages' do
    ...
    context 'with packages features enabled' do
      ...
      context 'with valid project' do
        let!(:package) { create(:composer_package, project: project) }
  ...
  describe 'GET /api/v4/group/:id/-/packages/composer/*package_name.json' do
    ...
    context 'with packages features enabled' do
      ...
      context 'with valid project and packages' do
        ...
        let!(:package) { create(:composer_package, name: package_name, project: project) }
  ...
  describe 'GET /api/v4/projects/:id/packages/composer/archives/*package_name?sha=:sha' do
    ...
    context 'with packages features enabled' do
      ...
      context 'with valid project' do
        ...
        context 'when the sha doesnt match the package name' do
          let(:sha) { '123' }

          it_behaves_like 'process Composer api request', :anonymous, :not_found
        end

        context 'when the package name doesnt match the sha' do
        ...
        context 'with a match package name and sha' do
          ...
          where(:project_visibility_level, :user_role, :member, :user_token, :shared_examples_name, :expected_status) do
            ...
            'PRIVATE' | :developer  | true  | false | 'process Composer api request' | :success
            'PRIVATE' | :guest      | true  | false | 'process Composer api request' | :success
            'PRIVATE' | :developer  | false | true  | 'process Composer api request' | :success
            'PRIVATE' | :guest      | false | true  | 'process Composer api request' | :success
            'PRIVATE' | :developer  | false | false | 'process Composer api request' | :success
            'PRIVATE' | :guest      | false | false | 'process Composer api request' | :success
            'PRIVATE' | :anonymous  | false | true  | 'process Composer api request' | :success
          end
