...
import { getYAxisOptions, getTooltipFormatter } from './options';
 ...
 *
 * `left` should give enough space for y axis with units and name.
 */
...
export default {
  ...
  computed: {
    ...
    chartOptions() {
      ...
      const dataYAxis = {
        ...getYAxisOptions({ name: this.graphData.y_label, ...this.graphData.yAxis }),
        ...yAxis,
      };
    ...
    tooltipYFormatter() {
      // Take the format of the y axis by default
      if (this.graphData.yAxis && this.graphData.yAxis.format) {
