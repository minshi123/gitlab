...
export const receiveMetricsDashboardSuccess = ({ commit, dispatch }, { response, params }) => {
  ...
  // TODO Remove this when BE changes to snake_case
  if (response.metrics_data && response.metrics_data['logs-path']) {
    // eslint-disable-next-line no-param-reassign
    response.metrics_data.logs_path = response.metrics_data['logs-path'];
    // eslint-disable-next-line no-param-reassign
    delete response.metrics_data['logs-path'];
  }
  // END TODO
