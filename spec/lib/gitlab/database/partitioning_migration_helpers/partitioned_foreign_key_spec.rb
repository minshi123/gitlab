...
describe Gitlab::Database::PartitioningMigrationHelpers::PartitionedForeignKey do
  ...
  describe "validations" do
    it "doesn't allow keys without a valid to_table" do
    ...
    it "doesn't allow keys without a valid from_table" do
    ...
    it "doesn't allow keys without a valid to_column" do
    ...
    it "doesn't allow keys without a valid from_column" do
