...
<template>
  ...
  >
    ...
    <template v-if="nodeActionsAllowed">
      <gl-button v-if="nodeMissingOauth" class="gl-mr-2 gl-ml-2" @click="onRepairNode">
        {{ s__('Repair authentication') }}
      </gl-button>
      <gl-button v-if="nodeEditAllowed" :href="node.editPath" class="gl-mr-2 gl-ml-2">
        {{ __('Edit') }}
      </gl-button>
      <gl-button
        v-if="isSecondaryNode"
