...
1. The file is opened in the Static Site Editor in **WYSIWYG** mode.
    1. If you wish to edit the raw Markdown instead, you can toggle the **Markdown** mode in the bottom right corner.
