...
Since [version 12.8](https://gitlab.com/gitlab-org/gitlab/issues/202696), the Y Axis scale does not automatically start from 0, adjusts according to the data.
