      ...
      module SettingsHelpers
        ...
        prepended do
          params :optional_params_ee do
            ...
            optional :maintenance_mode, type: Grape::API::Boolean, desc: 'When instance is in maintenance mode, non-admin users can sign in and make read-only API requests'
