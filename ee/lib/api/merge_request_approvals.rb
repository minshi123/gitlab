  ...
  class MergeRequestApprovals < ::Grape::API
    ...
    helpers do
      ...
      def present_merge_request_approval_state(presenter:, target_branch: nil)
        ...
        present(
          approval_state(merge_request, target_branch),
          with: presenter,
          current_user: current_user
        )
      end

      def approval_state(merge_request, target_branch)
        return merge_request.approval_state_for(target_branch) if target_branch
