...
describe('First class Project Security Dashboard component', () => {
  ...
  describe('when user visits for the first time', () => {
    ...
    it('displays a banner which describes the new functionality in the dashboard', () => {
      expect(findIntroductionBanner().text()).toContain(introductionBannerText);
      expect(findIntroductionBanner().text()).toContain(introductionBannerTitle);
