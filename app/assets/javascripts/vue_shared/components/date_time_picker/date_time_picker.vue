<script>
import { GlButton, GlDropdown, GlDropdownItem, GlFormGroup, GlIcon } from '@gitlab/ui';
...
export default {
  ...
  methods: {
    ...
    findTarget($el) {
      return $el.querySelector('.date-time-picker-toggle');
    },
  },
};
</script>
<template>
  ...
  >
    <gl-dropdown
      ...
      v-bind="$attrs"
      toggle-class="w-100 date-time-picker-toggle text-truncate"
    >
