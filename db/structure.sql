...
CREATE TABLE public.group_deploy_keys (
    ...
    CONSTRAINT check_f58fa0a0f7 CHECK ((char_length(key) <= 255))
);
...
CREATE INDEX index_group_deploy_keys_on_fingerprint ON public.group_deploy_keys USING btree (fingerprint);
