  ...
  describe('Base', () => {
    ...
    describe('computed', () => {
      describe('dropdownButtonTextClass', () => {
        it('should return string "is-default" when variant is "standalone"', () => {
          expect(wrapperStandalone.vm.dropdownButtonTextClass).toBe('is-default');
        });

        it('should return empty string when variant is "sidebar"', () => {
          expect(wrapper.vm.dropdownButtonTextClass).toBe('');
        });
      });
    });
