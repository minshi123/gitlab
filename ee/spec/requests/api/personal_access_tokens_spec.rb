  ...
  describe 'DELETE /personal_access_tokens/:id' do
    ...
    context 'when licensed' do
      ...
      context 'when current_user is an administrator', :enable_admin_mode do
        ...
        let(:admin_token) { create(:personal_access_token, user: current_user) }
        let(:admin_path) { "/personal_access_tokens/#{admin_token.id}" }
        ...
        it 'revokes their own token' do
          delete api(admin_path, current_user)
      ...
      context 'when current_user is not an administrator' do
        let(:user_token) { create(:personal_access_token, user: current_user) }
        let(:user_token_path) { "/personal_access_tokens/#{user_token.id}" }
