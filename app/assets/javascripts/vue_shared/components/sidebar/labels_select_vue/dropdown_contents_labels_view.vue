  ...
  methods: {
    ...
    handleKeyDown(e) {
      if (e.keyCode === UP_KEY_CODE && this.currentHighlightItem > 0) {
        ...
        this.toggleDropdownButtonAndContents();
      }
...
<template>
  <div class="labels-select-contents-list">
    ...
    <div class="dropdown-input">
      <gl-search-box-by-type ref="searchInput" v-model="searchKey" />
    </div>
    ...
    <div class="dropdown-footer">
      <ul class="list-unstyled">
        <li>
          <gl-link
            class="d-flex flex-row text-break-word label-item"
