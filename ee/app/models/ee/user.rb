  ...
  module User
    ...
    class_methods do
      ...
      def support_bot
        ...
        unique_internal(where(user_type: :SupportBot), 'support-bot', email_pattern) do |u|
      ...
      def visual_review_bot
        ...
        unique_internal(where(user_type: :VisualReviewBot), 'visual-review-bot', email_pattern) do |u|
