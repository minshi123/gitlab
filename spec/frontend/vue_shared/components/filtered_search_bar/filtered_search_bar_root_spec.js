...
describe('FilteredSearchBarRoot', () => {
  ...
  describe('computed', () => {
    ...
    describe('recentSearches', () => {
      it('returns array of strings representing recent searches', () => {
        wrapper.vm.recentSearchesStore.state.recentSearches = ['foo'];

        expect(wrapper.vm.recentSearches).toEqual(['foo']);
      });
    });
  ...
  describe('methods', () => {
    describe('setupRecentSearch', () => {
      it('sets `recentSearchesPromise` prop with a promise by using `recentSearchesService.fetch()`', () => {
        jest
