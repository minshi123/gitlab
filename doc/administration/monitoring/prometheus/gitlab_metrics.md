...
| `http_elasticsearch_requests_duration_seconds`                 | Histogram |                   13.1 | Elasticsearch requests duration during web transactions                                             | `controller`, `action`                              |
| `http_elasticsearch_requests_total`                            | Counter   |                   13.1 | Elasticsearch requests count during web transactions                                                | `controller`, `action`                              |
