...
module Geo
  ...
  class RegistryConsistencyService
    ...
    def execute
      ...
      [handle_differences_in_range(range), create_missing_above(end_of_batch: range.last)].flatten.compact.any?
    rescue => e
    ...
    def delete_unused_in_range(delete_unused_in_range)
      ...
      # TODO: Enqueue a DeleteRegistryWorker for each id in range
      delete_unused_in_range
    end
