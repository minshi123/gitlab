    ...
    context 'handling per_page param' do
      ...
      context 'when nil' do
        ...
        it "defaults to #{described_class::DEFAULT_PER_PAGE}" do
          expect_any_instance_of(Gitlab::SearchResults).to receive(:objects).with(anything, anything, described_class::DEFAULT_PER_PAGE)
      ...
      context 'when present' do
        ...
        it "converts to integer and passes to search results" do
          expect_any_instance_of(Gitlab::SearchResults).to receive(:objects).with(anything, anything, 50)
      ...
      context "when greater than #{described_class::MAX_PER_PAGE}" do
        ...
        it "passes #{described_class::MAX_PER_PAGE}" do
          expect_any_instance_of(Gitlab::SearchResults).to receive(:objects).with(anything, anything, described_class::MAX_PER_PAGE)
