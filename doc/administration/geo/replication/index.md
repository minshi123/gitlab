...
- Cloning, pulling or pushing over HTTP are supported for repositories that exist on the **primary**
node but not on the **secondary** nodes where selective synchronization does not include the project.
[SSH support](https://gitlab.com/groups/gitlab-org/-/epics/2562) is currently not supported
but is coming.
