...
module EE
  ...
  module Project
    ...
    prepended do
      ...
      has_one :vulnerability_stats, class_name: 'Vulnerabilities::Stats'
      ...
      scope :with_vulnerability_stats, -> { includes(:vulnerability_stats) }
      ...
      delegate :grade, to: :vulnerability_stats, prefix: :vulnerability
