  ...
  describe 'GET /issues' do
    ...
    context 'when authenticated' do
      ...
      context 'filtering by non_archived' do
        let(:archived_project) { create(:project, :archived, creator_id: user.id, namespace: user.namespace) }
        let!(:archived_issue) { create(:issue, author: user, project: archived_project) }
        let!(:active_issue) { create(:issue, author: user, project: project) }
