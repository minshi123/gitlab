...
class PrometheusService < MonitoringService
  ...
  with_options presence: true do
    validates :api_url, public_url: true, if: proc { |object| object.manual_configuration? && !object.allow_local_api_url? }
    validates :api_url, url: true, if: proc { |object| object.manual_configuration? && object.allow_local_api_url? }
  end
