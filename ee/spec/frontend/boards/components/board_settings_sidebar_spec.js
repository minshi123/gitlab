...
describe('BoardSettingsSideBar', () => {
  ...
  const createComponent = (state = { activeListId: inactiveListId }, actions = {}, localState = {}) => {
  ...
  describe('GlDrawer', () => {
    ...
    describe('on close', () => {
      it('calls closeSidebar', () => {
        const spy = jest.fn();
        createComponent({ activeListId: 1 }, { setActiveListId: spy });
      ...
      it('calls closeSidebar on sidebar.closeAll event', () => {
        createComponent({ activeListId: 1 }, { setActiveListId: jest.fn() });
