...
export default {
  ...
  computed: {
    ...mapState(['content']),
    ...mapGetters(['isContentLoaded', 'isLoadingContent', 'isSavingChanges', 'contentChanged']),
  },
  mounted() {
    this.loadContent();
  },
  methods: {
    ...mapActions(['loadContent', 'saveChanges']),
  },
};
</script>
<template>
  <div class="d-flex justify-content-center h-100  pt-2">
    ...
    <div v-if="isContentLoaded || isSavingChanges" class="d-flex flex-grow-1 flex-column">
      <edit-area class="w-75 h-100 shadow-none align-self-center" :value="content" />
      <toolbar
