...
module Gitlab
  module Geo
    ...
    def self.interacting_with_primary_message(url)
      ...
      #
      # remote:
      # remote: You're interacting with a Geo secondary! We'll help you by sending
      # remote: this this request to the primary:
      # remote:
      # remote:   <url>
      # remote:
      template = <<~STR
        You're interacting with a Geo secondary! We'll help you by sending
        this request to the primary:
