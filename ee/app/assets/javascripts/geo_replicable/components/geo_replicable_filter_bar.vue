...
<template>
  <nav
    class="geo-replicable-filter-bar d-flex align-items-center bg-secondary border-bottom border-secondary-100 p-3"
  >
    <gl-dropdown :text="__('Filter by status')">
      <gl-dropdown-item
