...
To view a large version of a visualization you can expand the panel. The data of a
single chart will be displayed in greater detail.

You may return any time by clicking the back button or pressing <kbd>Esc</kbd>.
