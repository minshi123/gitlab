...
describe ApplicationSetting do
  ...
  describe 'validations' do
    ...
    it { is_expected.to allow_value(['user1'] * 100).for(:issues_create_limit_users_whitelist) }
    it { is_expected.not_to allow_value(['user1'] * 101).for(:issues_create_limit_users_whitelist) }
    it { is_expected.not_to allow_value(nil).for(:issues_create_limit_users_whitelist) }
    it { is_expected.to allow_value([]).for(:issues_create_limit_users_whitelist) }
