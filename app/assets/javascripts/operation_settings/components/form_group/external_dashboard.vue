...
<template>
  <gl-form-group :label="s__('MetricsSettings|Full dashboard URL')" label-for="full-dashboard-url">
    <template #description>
      {{
        s__(
          'MetricsSettings|Add a button to the metrics dashboard linking directly to your existing external dashboards.',
        )
      }}
