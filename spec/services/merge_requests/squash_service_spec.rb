...
describe MergeRequests::SquashService do
  ...
  describe '#execute' do
    ...
    context 'when squashing is disabled by default on the project' do
      ...
      before do
        merge_request.project.project_setting.squash_option = 'enabled_with_default_off'
      end
    ...
    context 'when squashing is forbidden on the project' do
      ...
      before do
        merge_request.project.project_setting.squash_option = 'never_squash'
      end
    ...
    context 'when squashing is enabled by default on the project' do
      ...
      before do
        merge_request.project.project_setting.squash_option = 'always_squash'
      end
