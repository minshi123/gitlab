...
namespace :admin do
  ...
  namespace :geo do
    ...
    get '/projects', to: redirect('admin/geo/replication/projects')
    get '/uploads', to: redirect('admin/geo/replication/uploads')
    get '/designs', to: redirect('admin/geo/replication/designs')

    resources :nodes, only: [:index, :create, :new, :edit, :update]

    scope '/replication' do
      get '/', to: redirect('admin/geo/replication/projects')
