  ...
  describe 'GET /api/v4/group/:id/-/packages/composer/packages' do
    ...
    context 'with packages features enabled' do
      ...
      context 'with valid project' do
        ...
        with_them do
          it_behaves_like 'Composer api group access', params[:project_visibility_level], params[:user_role], params[:user_token] do
    ...
    shared_examples 'composer package publish' do
      context 'with packages features enabled' do
        ...
        context 'with valid project' do
          ...
          with_them do
            it_behaves_like 'Composer api project access', params[:project_visibility_level], params[:user_role], params[:user_token] do
              it_behaves_like params[:shared_examples_name], params[:user_role], params[:expected_status], params[:member]
            end
          end
        end
