...
describe ::Packages::Composer::PackagesPresenter do
  ...
  let_it_be(:package1) { create(:composer_package, project: project, name: package_name, version: '1.0.0') }
  let_it_be(:package2) { create(:composer_package, project: project, name: package_name, version: '2.0.0') }
  ...
  let(:presenter) { described_class.new(group, packages, json_files) }
