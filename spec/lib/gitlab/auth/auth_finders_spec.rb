  ...
  describe '#find_user_from_deploy_token' do
    ...
    context 'with deploy token headers' do
      before do
        ...
        set_header(described_class::DEPLOY_TOKEN_USER_HEADER, deploy_token.username)
      end
      ...
      context 'with incorrect username' do
        before do
          set_header(described_class::DEPLOY_TOKEN_USER_HEADER, 'invalid_user')
        end
    ...
    context 'with basic auth headers' do
      ...
      context 'with incorrect username' do
        before do
          set_basic_auth_header('invalid', deploy_token.token)
        end
