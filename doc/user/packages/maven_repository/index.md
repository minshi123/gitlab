...
installation is complete, verfify you can use Maven in your terminal by running:
...
Indicating that your project has been setup successfully. You should see a new
directory where you ran this command matching your `DartifactId` parameter (in
this case it should be `my-project`).
...
You should also see that the upload was to the correct registry:
...
Provided everything is setup correctly, you should see the dependency downloaded
