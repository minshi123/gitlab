...
| `iids[]`                          | integer array | optional | Return only the milestones having the given `iid` (Note: ignored if `include_parent_group_milestones` is present) |
| `state`                           | string | optional | Return only `active` or `closed` milestones |
| `title`                           | string | optional | Return only the milestones having the given `title` |
| `search`                          | string | optional | Return only milestones with a title or description matching the provided string |
| `include_parent_group_milestones` | boolean | optional | Include group milestones from parent group and ancestors. Introduced in [GitLab 13.3](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/#) |
