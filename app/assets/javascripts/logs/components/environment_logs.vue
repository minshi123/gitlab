  ...
  <div class="environment-logs-viewer mt-3">
    ...
    <div class="top-bar js-top-bar d-flex">
      <gl-dropdown
        ...
        class="d-flex gl-h-32 js-environments-dropdown pr-2"
      ...
      <log-advanced-filters
        ...
        :disabled="environments.isLoading"
      />
      <log-simple-filters v-else ref="log-simple-filters" class="flex-grow-1" :disabled="environments.isLoading" />

      <log-control-buttons
        ref="scrollButtons"
        class="flex-grow-0 controllers"
