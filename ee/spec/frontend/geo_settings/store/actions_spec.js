...
describe('GeoSettings Store Actions', () => {
  ...
  describe.each`
    ...
    ${actions.setError}     | ${{ key: 'timeout', error: 'error' }}                | ${types.SET_ERROR}      | ${{ type: types.SET_ERROR, payload: { key: 'timeout', error: 'error' } }}      | ${noCallback}
  ...
  describe.each`
    ...
    ${actions.updateGeoSettings} | ${{ method: 'onPut', code: 200, res: MOCK_APPLICATION_SETTINGS_FETCH_RESPONSE }} | ${'success'} | ${[{ type: types.REQUEST_UPDATE_GEO_SETTINGS }, { type: types.RECEIVE_UPDATE_GEO_SETTINGS_SUCCESS }]}                      | ${noCallback}
