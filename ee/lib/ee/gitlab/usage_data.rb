    ...
    module UsageData
      ...
      class_methods do
        ...
        def operations_dashboard_usage
          ...
          users_with_projects_added = count(UsersOpsDashboardProject.distinct_users(::User.active), :user_id)
        ...
        def system_usage_data
          super.tap do |usage_data|
            usage_data[:counts].merge!({
                                         ...
                                         projects_with_packages: distinct_count(::Packages::Package.select(:project_id), :project_id),
        ...
        def usage_activity_by_stage_monitor(time_period)
          {
            ...
            operations_dashboard_users_with_projects_added: count(UsersOpsDashboardProject.distinct_users(::User.active).where(time_period), :user_id),
