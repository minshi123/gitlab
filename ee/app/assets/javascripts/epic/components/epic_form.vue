  ...
  <div>
    ...
    <gl-form class="common-note-form">
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <gl-form-input id="epic-title" v-model="title" autocomplete="off" autofocus />
        </div>
      </div>
    ...
    <div class="form-actions gl-display-flex">
      ...
      <gl-button class="ml-auto" data-testid="cancel-epic" :href="groupEpicsPath">{{ __('Cancel') }}</gl-button>
    </div>
  </div>
</template>
