...
module Analytics
  module CycleAnalytics
    class BaseSummaryController < Analytics::ApplicationController
      ...
      def show
        ...
        render json: summary(group_level)
      end

      def summary(group_level)
        raise NotImplementedError.new("Expected #{self.name} to implement summary")
      end
