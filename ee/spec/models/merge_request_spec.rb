...
describe MergeRequest do
  ...
  describe 'review time sorting' do
    let!(:merge_request_1) { create(:merge_request, :with_productivity_metrics, metrics_data: { first_comment_at: 1.day.ago }) }
    let!(:merge_request_2) { create(:merge_request, :with_productivity_metrics, metrics_data: { first_comment_at: 3.days.ago }) }
    let!(:merge_request_3) { create(:merge_request, :with_productivity_metrics, metrics_data: { first_comment_at: nil }) }
