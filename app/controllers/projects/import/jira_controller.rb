  ...
  module Import
    class JiraController < Projects::ApplicationController
      ...
      def import
        ...
        @project.create_import_state unless import_state
        ...
        schedule_import(jira_import_params)
      ...
      def schedule_import(params)
        ...
        unless @project.import_data
          ...
          can_schedule = @project.save
        end

        @project.import_state.schedule if can_schedule
      end
