...
module Types
  class MutationType < BaseObject
    ...
    mount_mutation Mutations::Discussions::Resolve, description: 'Resolves a Discussion'
    mount_mutation Mutations::Discussions::Unresolve, description: 'Unresolves a Discussion'
